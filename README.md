...
This repo intentionally excludes bulky curation workspaces, source PDFs/OCR dumps, and calibration artifacts. It now includes a project agent operating system across `AGENTS.md`, `CLAUDE.md`, `CAPTAIN.md`, `BUILD.md`, and `REVIEW.md`, project-local curation skills under `skills/`, and vetted repo-scoped agent skills under `.agents/skills/`.
